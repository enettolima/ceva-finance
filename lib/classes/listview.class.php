 ...
 * listiview.class.php
 *
 * Builds lists for tables, pagination, sorting and search within datasets
 */
...
function build_sort_header($function, $module, $fields, $sort) {
	...
	if ($fields) {
        ...
        if ($sort == $field['field'] . ' ASC') {
	        //$line[$i] = '<a class="sort asc" onClick="proccess_information(\'' . $function . '_table_info\', \'' . $function . '_sort\', \'' . $module . '\', null, \'sort|' . $field['field'] . ' DESC\', null, ' . $container . ');">' . $field['display'] . '</a>';
	      ...
	      elseif ($sort == $field['field'] . ' DESC') {
	        //$line[$i] = '<a class="sort desc" onClick="proccess_information(\'' . $function . '_table_info\', \'' . $function . '_sort\', \'' . $module . '\', null, \'sort|' . $field['field'] . ' ASC\', null, ' . $container . ');">' . $field['display'] . '</a>';
		      ...
		      //$line[$i] = '<a class="sort" onClick="proccess_information(\'' . $function . '_table_info\', \'' . $function . '_sort\', \'' . $module . '\', null, \'sort|' . $field['field'] . ' ASC\', null, ' . $container . ');">' . $field['display'] . '</a>';
					$line[$i]['display'] = theme_link_process_information($field['display'], $function . '_table_info', $function . '_sort', $module, array('extra_value' => 'sort|' . $field['field'] . ' ASC'));
