...
/**
 * OLD behavior control and others configurations
 */
...
$(document).ready(function() {
    // Menu 
    $('.expanded > a').removeAttr('href');

    // Show color options											 
    $('#color-actual').click(function() {
        if ($('#colors').hasClass('opened')) {
            $('#colors').fadeOut('slow').removeClass('opened');
        } else {
            $('#colors').fadeIn('slow').addClass('opened');
        }
    });

    /*	$('.session-env-header').click(function(){
     $('.server-prop-content').toggle();
     });
     $('.session-prop-header').click(function(){
     $('.server-prop-content').toggle();
     });*/
    /*$('.session-env-header').click(function(){
     if($('#env-status').val()=="show"){
     $('.server-env-content').slideUp();
     $('#env-status').val('hide');
     }else{
     $('.server-env-content').fadeIn();
     $('#env-status').val('show');
     }
     });
     $('.session-prop-header').click(function(){
     if($('#prop-status').val()=="show"){
     $('.server-prop-content').slideUp();
     $('#prop-status').val('hide');
     }else{
     $('.server-prop-content').fadeIn();
     $('#prop-status').val('show');
     }
     });*/
...
/**
 * Add class active for the items on the panel-left
 */
$(document).ready(function() {
    $('#panel-left ul li').live('click', function() {
        var element = this;
        $('#panel-left ul li').removeClass('active');
        $(element).addClass('active');
    });
});

function show_submenu(el) {
    $(el).children(el + '.sub-menu').css({
        width: '160px',
        top: '39px',
        left: '0'
    }).fadeIn();
...
// Fix for jQuery bug when using slide down and slide up 
 ...
 */
$(document).ready(function() {
    $('.help-block').live('click', function() {
        if ($(this).hasClass('closed')) {
            $(this).removeClass('closed').addClass('opened');
...
function multiple_forms_actions() {
    ...
    $('#sortable').live('sortupdate', function() {
        var i = 0;
        $('.single-form h2 span').each(function() {
            $(this).html(i);
            i++;
...
$(document).ready(function() {
    // Close button
    $('.close_order_notes').live('click', function() {
        // This closes all other notes which are opened
        $('tr.order_notes').remove();
        $('.order_status').removeClass('opened');
    ...
    $('.order_simple_note').live('click', function() {
        var element = this;
    ...
    $('.order_edit').live('click', function() {
        var element = this;
    ...
    $('.close_order_tasks').live('click', function() {
        // This closes all other notes which are opened
        $('tr.order_tasks').remove();
        $('.order_edit').removeClass('opened');
    })
    ...
    // Close button
    $('.close_order_task_notes').live('click', function() {
        // This closes all other notes which are opened
        $('tr.order_task_notes').remove();
        $('.order_task_status').removeClass('opened');
    ...
    // Add new order note
    $('.add_new_task_note').live('click', function() {
        var element = this;
    ...
    $('.order_task_simple_note').live('click', function() {
        var element = this;
    ...
    $('.wowwe_auth').live('click', function() {
...
$(document).ready(function() {
    // Close button
    $('.close_trouble_ticket_notes').live('click', function() {
        // This closes all other notes which are opened
        $('tr.trouble_ticket_notes').remove();
        $('.trouble_ticket_status').removeClass('opened');
    ...
    $('.trouble_ticket_simple_note').live('click', function() {
        var element = this;
    ...
    // Add new note
    $('.add_new_trouble_ticket_note').live('click', function() {
        var element = this;
...
$(document).ready(function() {
    ...
    // Open Close Info												 
    $('.customer_account_block h3').live('click', function() {
    ...
    // Open Close Form
    $('.customer_account_block .edit').live('click', function() {
    ...
    $('.customer_account_form_cancel').live('click', function() {
        $(this).parent('.form').slideUp('slow', function() {
            $(this).siblings('div.info').slideDown();
        });
    });

    $('.customer_account_form_save').live('click', function() {
        var element = this;
