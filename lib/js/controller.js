...
function file_uploader(e, extensions) {
  ...
  new AjaxUpload(button, {
    action: 'modules/upload/uploader.php?button_id=' + e,
    name: 'myfile',
    ...
    onComplete: function(file, response) {
      ...
      if (response == 'uploaded') {
        ...
        if (str.search(file) < 0) {
          $('<li class="file-item"></li>').appendTo('#uploaded-files-' + e).html('<span class="file-name">' + file + '</span> <a class="file-delete" title="Delete" onclick="file_delete(\'' + file + '\', this, ' + e +');"><i class="fa fa-trash-o"></i></a>');
          $('#files-' + e).val($('#files-' + e).val() + file + '\n');
        }
        else {
          // TODO: Needs to be server side... not on client side
